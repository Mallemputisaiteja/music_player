...
function playTrack() {
  musicObj.play();
  isPlaying = true;
  playPauseBtn.innerHTML = '<i class="material-icons pause" style="color: #17ee7e;">pause_circle</i>';
}
...
function pauseTrack() {
  musicObj.pause();
  isPlaying = false;
  playPauseBtn.innerHTML =  '<i class="material-icons" style="color: #17ee7e;">play_circle_filled</i>';
}
